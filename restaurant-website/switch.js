...
function ContactLightMode() {
  // Change the contact us submit button class name to the correct one
  document.getElementById("submit").style.backgroundColor = ""; 
  // ^^^^ Clear the style generated by the automatic light mode script 
  document.getElementById("submit").style.color = "black";
  document.getElementById("submit").className = "submit light-mode";

  let inputs = Array.from(document.getElementsByTagName("input"));
  inputs.forEach(input => {
    if (input !== document.getElementById("submit")) {
